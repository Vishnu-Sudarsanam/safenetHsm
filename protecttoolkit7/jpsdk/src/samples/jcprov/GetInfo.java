 ...
 * <li><i>slotId</i>    the realted slot Id of the slot or token information to retrieve, default (all)
 */
public class GetInfo
{
    ...
    static void DisplayGeneralInformation()
    {
        ...
        println("   Manufacturer       :" + new String(info.manufacturerID, StandardCharsets.US_ASCII));
        println("   Library Description:" + new String(info.libraryDescription, StandardCharsets.US_ASCII));
    ...
    static void DisplaySlotInformation(long slotId)
    {
        ...
        println("   Description     :" + new String(info.slotDescription, StandardCharsets.US_ASCII));
        println("   Manufacturer    :" + new String(info.manufacturerID, StandardCharsets.US_ASCII));
    ...
    static void DisplayTokenInformation(long slotId)
    {
        ...
        println("   Label           :" + new String(info.label, StandardCharsets.US_ASCII));
        println("   Manufacturer    :" + new String(info.manufacturerID, StandardCharsets.US_ASCII));
        println("   Model           :" + new String(info.model, StandardCharsets.US_ASCII));
        println("   Serial Number   :" + new String(info.serialNumber, StandardCharsets.US_ASCII));
        println("   Hardware Version:" + versionString(info.hardwareVersion));
        println("   Firmware Version:" + versionString(info.firmwareVersion));
        println("   Clock (GMT)     :" + new String(info.utcTime, StandardCharsets.US_ASCII));
